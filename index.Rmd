...
Taking total ad spend by 4th of March 2020, as reported by [CNN](https://edition.cnn.com/2020/03/02/politics/super-tuesday-ad-spending/index.html), and the number of delegates and votes, as reported by [Wikipedia as of 1546 UK time,  on 4th of March 2020](https://en.wikipedia.org/wiki/Results_of_the_2020_Democratic_Party_presidential_primaries#Super_Tuesday), we can look and see how directly ad spending correlates with voter preferences.
...
Caveat #1: Results are still coming in, so the actual figures will change (although the general pattern is likely to hold).
